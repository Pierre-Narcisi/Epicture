...
public class profileFragment extends Fragment {
    ...
    private void fetchData() {
        ...
        Request request = new Request.Builder()
                .url("https://api.imgur.com/3/account/"+username+"/submissions/0")
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button btn = view.findViewById(R.id.uploadImageButton);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent upload = new Intent(getActivity(), upload.class);
                upload.putExtra("accessToken", getActivity().getIntent().getStringExtra("accessToken"));
                upload.putExtra("username", getActivity().getIntent().getStringExtra("username"));
                upload.putExtra("accountId", getActivity().getIntent().getStringExtra("accountId"));
